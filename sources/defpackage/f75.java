...
public class f75 extends r51 {
    private final RecyclerView a;
    private final RecyclerView b;
    private final FrameLayout c;
    private final GlueHeaderLayout d;

    public f75(Context context, m mVar, Fragment fragment, tk9 tk9) {
        context.getClass();
        boolean e = ToolbarConfig.e(context, fragment);
        RecyclerView D = r51.D(context);
        this.a = D;
        D.setId(C0707R.id.artist_releases_glue_header_layout_recycler);
        D.setLayoutManager(mVar.create());
        RecyclerView E = r51.E(context);
        this.b = E;
        E.setId(C0707R.id.artist_releases_hub_glue_header_layout_overlays);
        FrameLayout frameLayout = new FrameLayout(context);
        this.c = frameLayout;
        frameLayout.setId(C0707R.id.artist_releases_hub_glue_header_layout_container);
