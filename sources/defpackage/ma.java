...
public class ma {
    ...
    public static androidx.work.c a(byte[] r6) {
        ...
        L_0x006c:
            goto L_0x006b
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ma.a(byte[]):androidx.work.c");
    }
    ...
    public static BackoffPolicy b(int i) {
        ...
        throw new IllegalArgumentException(je.q0("Could not convert ", i, " to BackoffPolicy"));
    }
    ...
    public static NetworkType c(int i) {
        ...
        throw new IllegalArgumentException(je.q0("Could not convert ", i, " to NetworkType"));
    }

    public static WorkInfo.State d(int i) {
        if (i == 0) {
        ...
        throw new IllegalArgumentException(je.q0("Could not convert ", i, " to State"));
    }

    public static int e(WorkInfo.State state) {
