...
public class a94 implements d<View> {
    ...
    public static class a {
        ...
        public s81 a() {
            s81.a y = z81.c().o("find:inlineEmptyState", HubsComponentCategory.CARD.d()).y(z81.h().a(this.a).d(this.b));
            p81 p81 = this.e;
            if (p81 != null) {
                y = y.h(p81);
            }
            if (this.d != null) {
                y = y.b(z81.c().n(HubsGlueRow.NORMAL).s("find_empty__button").y(z81.h().a(this.c)).f("click", this.d).h(this.e).l());
            }
            return y.l();
        }

        public a b(String str, o81 o81, p81 p81) {
            this.c = str;
            this.d = o81;
            this.e = p81;
            return this;
    ...
    public void c(android.view.View r2, defpackage.s81 r3, defpackage.w51 r4, defpackage.s51.b r5) {
        /*
            r1 = this;
            java.lang.Class<y84> r5 = defpackage.y84.class
            g90 r2 = defpackage.l70.o(r2, r5)
            y84 r2 = (defpackage.y84) r2
            w81 r5 = r3.text()
        ...
        L_0x007f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.a94.c(android.view.View, s81, w51, s51$b):void");
    }
    ...
    public View h(ViewGroup viewGroup, w51 w51) {
        z84 z84 = new z84(viewGroup);
        z84.getView().setTag(C0707R.id.glue_viewholder_tag, z84);
        return z84.getView();
    }
}
