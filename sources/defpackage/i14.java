...
public class i14 implements vud {
    ...
    public static class b {
        public static final jvd<Float> a = jvd.b(Float.valueOf(1.07f));
        public static final Interpolator b = ta0.d;
    }
    ...
    public void k() {
        ...
        jvd<Integer> jvd = d;
        jvd<Integer> jvd2 = e;
        this.b = new tud(((float) jvd.a().intValue()) / b2, ((float) jvd2.a().intValue()) / b2, this.a.getScaleX(), b.a.a().floatValue(), b.b);
        this.c = new tud(((float) jvd.a().intValue()) / b2, ((float) jvd2.a().intValue()) / b2, this.a.getTranslationY(), a.a.a().floatValue(), a.b);
    }
}
