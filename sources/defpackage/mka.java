...
public final class mka implements fjf<lka> {
    private final wlf<Context> a;
    private final wlf<k2> b;
    private final wlf<d3> c;
    private final wlf<j1> d;
    private final wlf<pea> e;

    public mka(wlf<Context> wlf, wlf<k2> wlf2, wlf<d3> wlf3, wlf<j1> wlf4, wlf<pea> wlf5) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
        this.d = wlf4;
    ...
    public Object get() {
        return new lka(this.a.get(), this.b.get(), this.c.get(), this.d.get(), this.e.get());
    }
}
