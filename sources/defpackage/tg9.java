...
public final class tg9 {
    ...
    private tg9(ShimmerFrameLayout shimmerFrameLayout, View view, RoundedRectView roundedRectView, RoundedRectView roundedRectView2) {
        this.a = shimmerFrameLayout;
    }

    public static tg9 b(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C0707R.layout.card_circular_skeleton_your_library_x, viewGroup, false);
        if (z) {
        ...
        if (findViewById != null) {
            ...
            if (roundedRectView != null) {
                ...
                if (roundedRectView2 != null) {
                    return new tg9((ShimmerFrameLayout) inflate, findViewById, roundedRectView, roundedRectView2);
                }
            }
        }
