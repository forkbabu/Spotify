...
public class t1<K, V> {
        ...
        if (obj instanceof t1) {
            ...
            for (int i = 0; i < this.c; i++) {
                try {
                    K i2 = i(i);
                    V m = m(i);
                    Object obj2 = t1Var.get(i2);
                    if (m == null) {
                        if (obj2 != null || !t1Var.containsKey(i2)) {
                            return false;
                        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: t1<K, V> */
    /* JADX WARN: Multi-variable type inference failed */
    public void j(t1<? extends K, ? extends V> t1Var) {
        int i = t1Var.c;
        b(this.c + i);
        if (this.c != 0) {
            for (int i2 = 0; i2 < i; i2++) {
                put(t1Var.i(i2), t1Var.m(i2));
            }
        } else if (i > 0) {
            System.arraycopy(t1Var.a, 0, this.a, 0, i);
            System.arraycopy(t1Var.b, 0, this.b, 0, i << 1);
            this.c = i;
        }
    }
