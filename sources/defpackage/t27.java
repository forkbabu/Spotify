...
public final class t27 implements fjf<EpisodeDecorationPolicy> {
    private final wlf<Map<String, Boolean>> a;
    private final wlf<Map<String, Boolean>> b;
    private final wlf<Map<String, Boolean>> c;

    public t27(wlf<Map<String, Boolean>> wlf, wlf<Map<String, Boolean>> wlf2, wlf<Map<String, Boolean>> wlf3) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
    }
