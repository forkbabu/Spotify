...
public final class wxb implements hqd, jqd, kqd, lqd, mqd, nqd, brd, e, d, com.spotify.nowplaying.ui.components.controls.previous.d, lmb, h, drd, erd, iqd, frd, g0 {
    private final c a;
    private final a b;
    private final ere c;
    private final c2 d;
    ...
    public wxb(c cVar, a aVar, ere ere, com.spotify.instrumentation.a aVar2, com.spotify.music.libs.viewuri.c cVar2) {
        this.a = cVar;
        this.b = aVar;
        this.c = ere;
        this.d = new c2(aVar2.path(), cVar2.toString());
    ...
    public void x(String str, boolean z) {
        this.a.k(str, z);
        if (z) {
            this.c.a(this.d.e().c().b(str));
        } else {
            this.c.a(this.d.e().c().a(str));
        }
    }
