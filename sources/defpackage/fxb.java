...
public final class fxb implements fjf<exb> {
    ...
    public fxb(wlf<c> wlf, wlf<a> wlf2, wlf<ere> wlf3, wlf<com.spotify.instrumentation.a> wlf4, wlf<com.spotify.music.libs.viewuri.c> wlf5) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
        this.d = wlf4;
    ...
    public Object get() {
        return new exb(this.a.get(), this.b.get(), this.c.get(), this.d.get(), this.e.get());
    }
}
