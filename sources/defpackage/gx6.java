...
public final class gx6 implements fjf<fx6> {
    private final wlf<wt6> a;
    private final wlf<SnackbarManager> b;
    private final wlf<h0> c;
    private final wlf<v> d;

    public gx6(wlf<wt6> wlf, wlf<SnackbarManager> wlf2, wlf<h0> wlf3, wlf<v> wlf4) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
        this.d = wlf4;
    ...
    public Object get() {
        return new fx6(this.a.get(), this.b.get(), this.c.get(), this.d.get());
    }
}
