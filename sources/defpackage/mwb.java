...
public final class mwb implements hqd, jqd, kqd, lqd, mqd, nqd, brd, e, d, com.spotify.nowplaying.ui.components.controls.previous.d, crd, lmb, h, erd, iqd, frd, g0 {
    private final c a;
    private final a b;
    private final ere c;
    private final b2 d;
    ...
    public mwb(c cVar, a aVar, ere ere, com.spotify.instrumentation.a aVar2, com.spotify.music.libs.viewuri.c cVar2) {
        this.a = cVar;
        this.b = aVar;
        this.c = ere;
        this.d = new b2(aVar2.path(), cVar2.toString());
