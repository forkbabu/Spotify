...
public final class uja implements fjf<tja> {
    ...
    public uja(wlf<Context> wlf, wlf<k2> wlf2, wlf<d3> wlf3, wlf<b2> wlf4, wlf<pea> wlf5) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
        this.d = wlf4;
    ...
    public Object get() {
        return new tja(this.a.get(), this.b.get(), this.c.get(), this.d.get(), this.e.get());
    }
}
