...
public class to8 extends ConstraintLayout implements sl8 {
    private final sl8.a a;
    private final rl8 b;
    private GridRecyclerView c = ((GridRecyclerView) findViewById(C0707R.id.recycler_view));
    private cl8 f;

    public to8(Context context, sl8.a aVar, rl8 rl8) {
        super(context);
        ViewGroup.inflate(getContext(), C0707R.layout.taste_picker_grid_view, this);
