...
public class ua8 implements jb8 {
    private final ere a;
    private final jz1 b;
    private final ifd c;
    private final c.a d;
    ...
    public ua8(ere ere, jz1 jz1, ifd ifd, c.a aVar, cqe cqe) {
        this.a = ere;
        this.b = jz1;
        this.c = ifd;
        this.d = aVar;
    ...
    public String a(x98 x98) {
        ...
        c.a aVar2 = this.d;
        aVar2.getClass();
        jz1.a(new fa1(c2.orNull(), name, aVar2.getViewUri().toString(), d2.orNull(), (long) b3, str, "hit", "navigate-forward", (double) this.e.d()));
        return b2;
    }
