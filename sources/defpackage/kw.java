...
public class kw {
    ...
    private static boolean b(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return c(packageInfo, c, d);
        }
        return c(packageInfo, c);
    }

    private static boolean c(PackageInfo packageInfo, byte[]... bArr) {
        Signature[] signatureArr = packageInfo.signatures;
    ...
    public final boolean d(String str) {
        ...
        try {
            packageInfo = xr.a(this.a).e(str, 64);
