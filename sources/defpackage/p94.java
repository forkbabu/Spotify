...
public class p94 {
    ...
    public p94(Context context) {
        ...
        this.b = paint2;
        int b2 = a.b(context, C0707R.color.browse_promo_background_gradient_start);
        int b3 = a.b(context, C0707R.color.browse_promo_background_gradient_end);
        int b4 = a.b(context, C0707R.color.browse_promo_background_overlay);
