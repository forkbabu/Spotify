...
public final class eq5 implements fjf<dq5> {
    ...
    public eq5(wlf<cqe> wlf, wlf<d> wlf2, wlf<pea> wlf3, wlf<e0> wlf4, wlf<p> wlf5, wlf<b3> wlf6, wlf<v1> wlf7) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
        this.d = wlf4;
    ...
    public Object get() {
        return new dq5(this.a, this.b, this.c, this.d, this.e, this.f, this.g);
    }
}
