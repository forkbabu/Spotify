...
public class FileTypeBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        bpf bpf = new bpf("FileTypeBox.java", FileTypeBox.class);
        ajc$tjp_0 = bpf.g("method-execution", bpf.f("1", "getMajorBrand", "com.coremedia.iso.boxes.FileTypeBox", "", "", "", "java.lang.String"), 85);
        ajc$tjp_1 = bpf.g("method-execution", bpf.f("1", "setMajorBrand", "com.coremedia.iso.boxes.FileTypeBox", "java.lang.String", "majorBrand", "", "void"), 94);
        ajc$tjp_2 = bpf.g("method-execution", bpf.f("1", "setMinorVersion", "com.coremedia.iso.boxes.FileTypeBox", Constants.LONG, "minorVersion", "", "void"), 103);
        ajc$tjp_3 = bpf.g("method-execution", bpf.f("1", "getMinorVersion", "com.coremedia.iso.boxes.FileTypeBox", "", "", "", Constants.LONG), 113);
        ajc$tjp_4 = bpf.g("method-execution", bpf.f("1", "getCompatibleBrands", "com.coremedia.iso.boxes.FileTypeBox", "", "", "", "java.util.List"), 122);
        ajc$tjp_5 = bpf.g("method-execution", bpf.f("1", "setCompatibleBrands", "com.coremedia.iso.boxes.FileTypeBox", "java.util.List", "compatibleBrands", "", "void"), 126);
    }
    ...
    public String toString() {
        StringBuilder Z0 = je.Z0("FileTypeBox[", "majorBrand=");
