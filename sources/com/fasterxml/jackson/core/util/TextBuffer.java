...
public final class TextBuffer {
    ...
    private char[] buf(int i) {
        ...
        return new char[Math.max(i, (int) Constants.ONE_SECOND)];
    }
    ...
    private void expand() {
        ...
        this._currentSegment = new char[i];
    }
        ...
        if (cArr == null) {
            ...
            if (str != null) {
                ...
                if (i2 >= 0) {
                    ...
                    if (i3 >= 1) {
                        cArr = i2 == 0 ? Arrays.copyOf(this._inputBuffer, i3) : Arrays.copyOfRange(this._inputBuffer, i2, i3 + i2);
                    }
                } else {
                    int size = size();
                    if (size >= 1) {
    ...
    public BigDecimal contentsAsDecimal() {
        ...
        if (cArr3 != null) {
            int i = NumberInput.a;
            return NumberInput.parseBigDecimal(cArr3, 0, cArr3.length);
        }
        int i2 = this._inputStart;
    ...
    public void releaseBuffers() {
        if (this._allocator == null) {
            ...
            this._allocator._charBuffers[2] = cArr;
        }
    }
