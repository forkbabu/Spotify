...
public final class ManagedReferenceProperty extends SettableBeanProperty.Delegating {
    ...
    public void deserializeAndSet(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) {
        setAndReturn(obj, this.delegate.deserialize(jsonParser, deserializationContext));
    }
    ...
    public Object setAndReturn(Object obj, Object obj2) {
        if (obj2 != null) {
            if (!this._isContainer) {
                ...
                StringBuilder V0 = je.V0("Unsupported container type (");
                V0.append(obj2.getClass().getName());
                V0.append(") when resolving reference '");
                throw new IllegalStateException(je.I0(V0, this._referenceName, "'"));
            }
        }
