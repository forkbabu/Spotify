...
class DeviceInfo {
    ...
    public void reloadPlayIds(Context context) {
        ...
        for (int i = 1; i <= 3; i++) {
            try {
                GooglePlayServicesClient.GooglePlayServicesInfo googlePlayServicesInfo = GooglePlayServicesClient.getGooglePlayServicesInfo(context, (long) (i * SnackbarUtilsKt.SNACKBAR_BASELINE_DURATION));
