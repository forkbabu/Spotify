...
public interface Constants {
    ...
    public static final String BASE_URL_CN = "https://app.adjust.world";
    public static final String BASE_URL_IN = "https://app.adjust.net.in";
    public static final String CALLBACK_PARAMETERS = "callback_params";
    public static final String CLIENT_SDK = "android4.24.0";
    ...
    public static final String[] FALLBACK_BASE_URLS = {BASE_URL_IN, BASE_URL_CN};
    public static final String[] FALLBACK_BASE_URLS_CN = {BASE_URL};
    public static final String[] FALLBACK_BASE_URLS_IN = {BASE_URL};
    public static final String[] FALLBACK_GDPR_URLS = {GDPR_URL_IN, GDPR_URL_CN};
    public static final String[] FALLBACK_GDPR_URLS_CN = {GDPR_URL};
    public static final String[] FALLBACK_GDPR_URLS_IN = {GDPR_URL};
    public static final String[] FALLBACK_SUBSCRIPTION_URLS = {SUBSCRIPTION_URL_IN, SUBSCRIPTION_URL_CN};
    public static final String[] FALLBACK_SUBSCRIPTION_URLS_CN = {SUBSCRIPTION_URL};
    public static final String[] FALLBACK_SUBSCRIPTION_URLS_IN = {SUBSCRIPTION_URL};
    ...
    public static final String GDPR_URL_CN = "https://gdpr.adjust.world";
    public static final String GDPR_URL_IN = "https://gdpr.adjust.net.in";
    ...
    public static final String SUBSCRIPTION_URL_CN = "https://subscription.adjust.world";
    public static final String SUBSCRIPTION_URL_IN = "https://subscription.adjust.net.in";
