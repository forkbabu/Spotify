...
public abstract class ImmutableCollection<E> extends AbstractCollection<E> implements Serializable {
    ...
    public static abstract class Builder<E> {
        ...
        /* renamed from: add */
        public abstract Builder<E> mo53add(E e);
    ...
    public final <T> T[] toArray(T[] tArr) {
        ...
        if (tArr.length < size) {
            ...
            tArr = (T[]) Collections2.newArray(tArr, size);
    ...
    public static abstract class ArrayBasedBuilder<E> extends Builder<E> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.google.common.collect.ImmutableCollection$ArrayBasedBuilder<E> */
        ...
        public Builder<E> addAll(Iterable<? extends E> iterable) {
            ...
            while (it.hasNext()) {
                mo53add((ArrayBasedBuilder<E>) it.next());
            }
            return this;
        }
        ...
        /* renamed from: add */
        public ArrayBasedBuilder<E> mo53add(E e) {
            e.getClass();
