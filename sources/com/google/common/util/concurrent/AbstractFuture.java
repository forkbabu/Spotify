...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static abstract class AtomicHelper {
        AtomicHelper(AnonymousClass1 r1) {
        }
    ...
    private static final class SynchronizedHelper extends AtomicHelper {
        SynchronizedHelper(AnonymousClass1 r1) {
            super(null);
        }
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        UnsafeAtomicHelper(AnonymousClass1 r1) {
            super(null);
        }
    ...
    public void addListener(Runnable runnable, Executor executor) {
        ...
        if (isDone() || (listener = this.listeners) == listener2) {
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return je.I0(je.V0("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
        if (!(this instanceof ScheduledFuture)) {
            return null;
        }
        StringBuilder V0 = je.V0("remaining delay=[");
        V0.append(((ScheduledFuture) this).getDelay(TimeUnit.MILLISECONDS));
        V0.append(" ms]");
        return V0.toString();
    }
    ...
    public V get() {
        ...
        if (!Thread.interrupted()) {
            ...
            if (waiter2 != waiter) {
                ...
                do {
                    ATOMIC_HELPER.putNext(waiter3, waiter2);
