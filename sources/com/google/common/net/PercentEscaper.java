...
public final class PercentEscaper extends UnicodeEscaper {
    ...
    public PercentEscaper(String str, boolean z) {
        if (!str.matches(".*[0-9A-Za-z].*")) {
            String x0 = je.x0(str, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
            if (!z || !x0.contains(" ")) {
                this.plusForSpace = z;
    ...
    public char[] escape(int i) {
        ...
        if (i <= 127) {
            ...
            throw new IllegalArgumentException(je.p0("Invalid unicode character value ", i));
        }
    }
