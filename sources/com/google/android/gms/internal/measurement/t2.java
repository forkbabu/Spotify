...
public final class t2 {
    private final ConcurrentHashMap<x2, List<Throwable>> a = new ConcurrentHashMap<>(16, 0.75f, 10);
    ...
    public final List a(Throwable th) {
        ...
        List<Throwable> list = this.a.get(new x2(th, null));
        if (list != null) {
            return list;
        }
        Vector vector = new Vector(2);
        List<Throwable> putIfAbsent = this.a.putIfAbsent(new x2(th, this.b), vector);
