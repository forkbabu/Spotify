...
public class FlowLayout extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(C0707R.id.row_index_key, -1);
            } else {
                ViewGroup.LayoutParams layoutParams = childAt.getLayoutParams();
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                    ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
                    i5 = e2.k(marginLayoutParams);
                    i6 = e2.j(marginLayoutParams);
                } else {
                    i6 = 0;
                    i5 = 0;
                }
                ...
                childAt.setTag(C0707R.id.row_index_key, Integer.valueOf(this.f - 1));
                int i11 = i8 + i5;
    ...
    public FlowLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.c = false;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, pw.p, 0, 0);
