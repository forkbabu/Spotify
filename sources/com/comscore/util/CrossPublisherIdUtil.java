...
public class CrossPublisherIdUtil {
    ...
    public static GeneratedCrossPublisherId getGeneratedCrossPublisherDeviceId() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            try {
                String generatedCrossPublisherDeviceIdNative = getGeneratedCrossPublisherDeviceIdNative();
                String substring = generatedCrossPublisherDeviceIdNative.substring(2);
                boolean z = false;
                if (generatedCrossPublisherDeviceIdNative.charAt(0) == '1') {
                    z = true;
                }
    ...
    private static native String getGeneratedCrossPublisherDeviceIdNative();
