...
public interface AdvertisementType {
    public static final int[] ALLOWED_VALUES = {ON_DEMAND_PRE_ROLL, ON_DEMAND_MID_ROLL, ON_DEMAND_POST_ROLL, LIVE, BRANDED_ON_DEMAND_PRE_ROLL, BRANDED_ON_DEMAND_MID_ROLL, BRANDED_ON_DEMAND_POST_ROLL, BRANDED_AS_CONTENT, BRANDED_DURING_LIVE, 200};
