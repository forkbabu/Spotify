...
final class PickerFragment$renderSections$$inlined$forEach$lambda$2 extends Lambda implements rmf<j, Integer, f> {
    final /* synthetic */ Ref$IntRef $sectionIndex$inlined;
    final /* synthetic */ PickerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PickerFragment$renderSections$$inlined$forEach$lambda$2(PickerFragment pickerFragment, Ref$IntRef ref$IntRef) {
        super(2);
