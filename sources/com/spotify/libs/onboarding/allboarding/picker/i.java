...
final class i<T> implements v<List<? extends j>> {
    ...
    i(AllboardingRvAdapter allboardingRvAdapter, com.spotify.libs.onboarding.allboarding.room.v vVar, PickerFragment pickerFragment, Ref$IntRef ref$IntRef) {
