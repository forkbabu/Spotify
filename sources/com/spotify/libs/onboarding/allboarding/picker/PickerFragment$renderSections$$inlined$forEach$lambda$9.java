...
final class PickerFragment$renderSections$$inlined$forEach$lambda$9 extends Lambda implements smf<j, Integer, Boolean, f> {
    final /* synthetic */ g $setPickerItemSelectedClickHandler;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PickerFragment$renderSections$$inlined$forEach$lambda$9(g gVar) {
        super(3);
