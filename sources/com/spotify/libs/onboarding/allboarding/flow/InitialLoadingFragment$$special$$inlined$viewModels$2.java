...
public final class InitialLoadingFragment$$special$$inlined$viewModels$2 extends Lambda implements cmf<h0> {
    final /* synthetic */ cmf $ownerProducer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InitialLoadingFragment$$special$$inlined$viewModels$2(cmf cmf) {
        super(0);
