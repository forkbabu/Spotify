...
public final class ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem extends GeneratedMessageLite<ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem, a> implements Object {
    private static final ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem p;
    private static volatile x<ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem> q;
    private int a;
    private String b = "";
    ...
    public static final class a extends GeneratedMessageLite.b<ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem, a> implements Object {
        private a() {
            super(ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.p);
        }
    }

    static {
        ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem = new ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem();
        p = showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem;
        showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.makeImmutable();
    }

    private ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem() {
    }

    public static x<ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem> parser() {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke.ordinal()) {
            ...
            case 1:
                ...
                ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem = (ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem) obj2;
                this.b = hVar.n(l(), this.b, showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.l(), showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.b);
                this.c = (EpisodeMetadata$ProtoEpisodeMetadata) hVar.i(this.c, showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.c);
                this.f = (EpisodeState$ProtoEpisodeCollectionState) hVar.i(this.f, showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.f);
                this.n = (EpisodeState$ProtoEpisodeOfflineState) hVar.i(this.n, showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.n);
                this.o = (EpisodeState$ProtoEpisodePlayState) hVar.i(this.o, showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.o);
                if (hVar == GeneratedMessageLite.g.a) {
                    this.a |= showOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.a;
                }
                return this;
            case 2:
                g gVar = (g) obj;
            ...
            case 3:
                return null;
            case 4:
                return new ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem();
            case 5:
                return new a();
            case 6:
                break;
            case 7:
                if (q == null) {
                    synchronized (ShowOfflinedEpisodesRequest$ProtoOfflinedEpisodesRequestItem.class) {
                        if (q == null) {
