...
public final class ConsumerResponse extends GeneratedMessageLite<ConsumerResponse, b> implements Object {
    private static final ConsumerResponse b;
    private static volatile x<ConsumerResponse> c;
    private o.i<Story> a = GeneratedMessageLite.emptyProtobufList();

    public static final class b extends GeneratedMessageLite.b<ConsumerResponse, b> implements Object {
        private b() {
            super(ConsumerResponse.b);
        }
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke.ordinal()) {
            case 0:
                return b;
            case 1:
                this.a = ((GeneratedMessageLite.h) obj).q(this.a, ((ConsumerResponse) obj2).a);
                return this;
            case 2:
                g gVar = (g) obj;
                k kVar = (k) obj2;
                    ...
                    try {
                        ...
                        if (B != 0) {
                            if (B == 10) {
                                ...
                                this.a.add(gVar.o(Story.parser(), kVar));
                            } else if (!gVar.F(B)) {
                            }
                        }
                        z = true;
