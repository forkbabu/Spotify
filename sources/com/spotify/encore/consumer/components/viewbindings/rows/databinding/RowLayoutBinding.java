...
public final class RowLayoutBinding {
    ...
    private RowLayoutBinding(ConstraintLayout constraintLayout, ViewStub viewStub, ViewStub viewStub2, ArtworkView artworkView, DownloadBadgeView downloadBadgeView, LyricsBadgeView lyricsBadgeView, PremiumBadgeView premiumBadgeView, QuickActionView quickActionView, ContentRestrictionBadgeView contentRestrictionBadgeView, ConstraintLayout constraintLayout2, TextView textView, TextView textView2) {
                                ...
                                if (quickActionView != null) {
                                    ...
                                    if (contentRestrictionBadgeView != null) {
                                        ...
                                        if (textView != null) {
                                            ...
                                            if (textView2 != null) {
                                                return new RowLayoutBinding(constraintLayout, viewStub, viewStub2, artworkView, downloadBadgeView, lyricsBadgeView, premiumBadgeView, quickActionView, contentRestrictionBadgeView, constraintLayout, textView, textView2);
                                            }
                                        }
                                    }
                                }
