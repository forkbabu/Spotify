...
public interface CollectionRowListeningHistory extends Component<Model, Events> {

    public static final class DefaultImpls {
        public static void onEvent(CollectionRowListeningHistory collectionRowListeningHistory, nmf<? super Events, f> nmf) {
            h.e(nmf, "event");
            Component.DefaultImpls.onEvent(collectionRowListeningHistory, nmf);
        }
    }
