...
public interface AlbumRowListeningHistory extends Component<Model, Events> {
    ...
    public static final class DefaultImpls {
        public static void onEvent(AlbumRowListeningHistory albumRowListeningHistory, nmf<? super Events, f> nmf) {
            h.e(nmf, "event");
            Component.DefaultImpls.onEvent(albumRowListeningHistory, nmf);
        }
    }
