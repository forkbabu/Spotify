package com.spotify.encore.consumer.components.listeninghistory.api.searchrow;
...
public interface SearchRowListeningHistory extends Component<Model, Events> {

    public static final class DefaultImpls {
        public static void onEvent(SearchRowListeningHistory searchRowListeningHistory, nmf<? super Events, f> nmf) {
            h.e(nmf, "event");
            Component.DefaultImpls.onEvent(searchRowListeningHistory, nmf);
        }
    }
