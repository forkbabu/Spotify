package com.spotify.encore.consumer.components.listeninghistory.api.playlistrow;
...
public interface PlaylistRowListeningHistory extends Component<Model, Events> {

    public static final class DefaultImpls {
        public static void onEvent(PlaylistRowListeningHistory playlistRowListeningHistory, nmf<? super Events, f> nmf) {
            h.e(nmf, "event");
            Component.DefaultImpls.onEvent(playlistRowListeningHistory, nmf);
        }
    }
