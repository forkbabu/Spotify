package com.spotify.encore.consumer.components.listeninghistory.api.internalrow;
...
public interface InternalRowListeningHistory extends Component<Model, Events> {

    public static final class DefaultImpls {
        public static void onEvent(InternalRowListeningHistory internalRowListeningHistory, nmf<? super Events, f> nmf) {
            h.e(nmf, "event");
            Component.DefaultImpls.onEvent(internalRowListeningHistory, nmf);
        }
    }
