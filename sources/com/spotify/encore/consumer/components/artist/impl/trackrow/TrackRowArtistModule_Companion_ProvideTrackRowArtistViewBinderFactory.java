...
public final class TrackRowArtistModule_Companion_ProvideTrackRowArtistViewBinderFactory implements fjf<DefaultTrackRowArtistViewBinder> {
    private final wlf<DefaultTrackRowArtist.ViewContext> contextProvider;

    public TrackRowArtistModule_Companion_ProvideTrackRowArtistViewBinderFactory(wlf<DefaultTrackRowArtist.ViewContext> wlf) {
        this.contextProvider = wlf;
    }

    public static TrackRowArtistModule_Companion_ProvideTrackRowArtistViewBinderFactory create(wlf<DefaultTrackRowArtist.ViewContext> wlf) {
        return new TrackRowArtistModule_Companion_ProvideTrackRowArtistViewBinderFactory(wlf);
    }
