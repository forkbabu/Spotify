...
public interface YourEpisodesCardLibrary extends Component<Model, Events> {
    ...
    public static final class DefaultImpls {
        public static void onEvent(YourEpisodesCardLibrary yourEpisodesCardLibrary, nmf<? super Events, f> nmf) {
            h.e(nmf, "event");
            Component.DefaultImpls.onEvent(yourEpisodesCardLibrary, nmf);
        }
    }
    ...
    public static final class Model {
        ...
        public Model(String str, LibraryItemDescription.Model.YourEpisodes yourEpisodes, DownloadState downloadState2, boolean z, boolean z2) {
            h.e(str, "name");
        ...
        public static /* synthetic */ Model copy$default(Model model, String str, LibraryItemDescription.Model.YourEpisodes yourEpisodes, DownloadState downloadState2, boolean z, boolean z2, int i, Object obj) {
            if ((i & 1) != 0) {
                str = model.name;
            }
            if ((i & 2) != 0) {
            ...
            return model.copy(str, yourEpisodes, downloadState2, z, z2);
        }
        ...
        public final Model copy(String str, LibraryItemDescription.Model.YourEpisodes yourEpisodes, DownloadState downloadState2, boolean z, boolean z2) {
            h.e(str, "name");
            h.e(yourEpisodes, "description");
            h.e(downloadState2, "downloadState");
            return new Model(str, yourEpisodes, downloadState2, z, z2);
        }
        ...
        public /* synthetic */ Model(String str, LibraryItemDescription.Model.YourEpisodes yourEpisodes, DownloadState downloadState2, boolean z, boolean z2, int i, kotlin.jvm.internal.f fVar) {
            this(str, (i & 2) != 0 ? new LibraryItemDescription.Model.YourEpisodes(0, true) : yourEpisodes, (i & 4) != 0 ? DownloadState.Empty : downloadState2, (i & 8) != 0 ? false : z, (i & 16) != 0 ? false : z2);
        }
    }
}
