...
public final class DefaultAlbumCardLibrary implements AlbumCardLibrary {
    private final LibraryCardLayoutBinding binding;

    public DefaultAlbumCardLibrary(Context context, Picasso picasso) {
        h.e(context, "context");
        h.e(picasso, "picasso");
    ...
    public void onEvent(nmf<? super AlbumCardLibrary.Events, f> nmf) {
        h.e(nmf, "event");
        getView().setOnClickListener(new DefaultAlbumCardLibrary$onEvent$1(nmf));
        getView().setOnLongClickListener(new DefaultAlbumCardLibrary$onEvent$2(nmf));
    }

    public void render(AlbumCardLibrary.Model model) {
        h.e(model, "model");
