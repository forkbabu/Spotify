...
public final class DefaultPodcastRowLibrary implements PodcastRowLibrary {
    ...
    public void onEvent(nmf<? super PodcastRowLibrary.Events, f> nmf) {
        h.e(nmf, "event");
        getView().setOnClickListener(new DefaultPodcastRowLibrary$onEvent$1(nmf));
        getView().setOnLongClickListener(new DefaultPodcastRowLibrary$onEvent$2(nmf));
        this.dismiss.setOnClickListener(new DefaultPodcastRowLibrary$onEvent$3(nmf));
    }
