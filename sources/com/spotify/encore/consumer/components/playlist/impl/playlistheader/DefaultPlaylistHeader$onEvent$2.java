...
final class DefaultPlaylistHeader$onEvent$2 extends Lambda implements nmf<f, f> {
    final /* synthetic */ nmf $consumer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DefaultPlaylistHeader$onEvent$2(nmf nmf) {
        super(1);
        this.$consumer = nmf;
    }
    ...
    public final void invoke(f fVar) {
        h.e(fVar, "it");
        this.$consumer.invoke(PlaylistHeader.Events.PlayButtonClicked);
    }
}
