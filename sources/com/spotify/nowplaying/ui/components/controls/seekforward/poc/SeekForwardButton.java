package com.spotify.nowplaying.ui.components.controls.seekforward.poc;
...
public final class SeekForwardButton extends AppCompatImageButton implements Element {
    ...
    public SeekForwardButton(Context context, AttributeSet attributeSet, int i) {
        ...
        setImageDrawable(gqd.s(context));
