...
@Deprecated
public abstract class LifecycleListenableDialogFragment extends DialogFragment implements k {
    private final Lifecycle$Listeners u0 = new Lifecycle$Listeners();
    ...
    public boolean y0(l lVar) {
        Lifecycle$Listeners lifecycle$Listeners = this.u0;
        lVar.getClass();
