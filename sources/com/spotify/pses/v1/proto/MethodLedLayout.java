...
public final class MethodLedLayout extends GeneratedMessageLite<MethodLedLayout, b> implements Object {
    private static final MethodLedLayout f;
    private static volatile x<MethodLedLayout> n;
    private Header a;
    private String b = "";
    private Authentication c;

    public static final class b extends GeneratedMessageLite.b<MethodLedLayout, b> implements Object {
        private b() {
            super(MethodLedLayout.f);
        }
    }
    ...
    static {
        ...
        f = methodLedLayout;
        methodLedLayout.makeImmutable();
    }

    private MethodLedLayout() {
    }

    public static MethodLedLayout i() {
        return f;
    }

    public static x<MethodLedLayout> parser() {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke.ordinal()) {
            ...
            case 1:
                ...
                MethodLedLayout methodLedLayout = (MethodLedLayout) obj2;
                this.a = (Header) hVar.i(this.a, methodLedLayout.a);
                this.b = hVar.n(!this.b.isEmpty(), this.b, true ^ methodLedLayout.b.isEmpty(), methodLedLayout.b);
                this.c = (Authentication) hVar.i(this.c, methodLedLayout.c);
                return this;
            case 2:
                g gVar = (g) obj;
                k kVar = (k) obj2;
