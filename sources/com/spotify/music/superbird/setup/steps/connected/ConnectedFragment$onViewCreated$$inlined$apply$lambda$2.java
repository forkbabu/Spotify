...
final class ConnectedFragment$onViewCreated$$inlined$apply$lambda$2 extends Lambda implements cmf<f> {
    final /* synthetic */ ConnectedFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConnectedFragment$onViewCreated$$inlined$apply$lambda$2(ConnectedFragment connectedFragment) {
        super(0);
