...
final class DownloadedFragment$onViewCreated$$inlined$apply$lambda$2 extends Lambda implements cmf<f> {
    final /* synthetic */ DownloadedFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DownloadedFragment$onViewCreated$$inlined$apply$lambda$2(DownloadedFragment downloadedFragment) {
        super(0);
