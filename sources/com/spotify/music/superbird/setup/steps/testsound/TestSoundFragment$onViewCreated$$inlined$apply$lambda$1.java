...
final class TestSoundFragment$onViewCreated$$inlined$apply$lambda$1 extends Lambda implements cmf<f> {
    final /* synthetic */ TestSoundFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TestSoundFragment$onViewCreated$$inlined$apply$lambda$1(TestSoundFragment testSoundFragment) {
        super(0);
