...
final class ExpandableReleaseComponentBinder$bindView$3 extends Lambda implements cmf<f> {
    ...
    ExpandableReleaseComponentBinder$bindView$3(c cVar, String str, int i, String str2, String str3) {
        super(0);
        this.this$0 = cVar;
        this.$itemId = str;
        this.$itemPosition = i;
