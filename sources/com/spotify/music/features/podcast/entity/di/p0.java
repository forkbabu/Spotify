...
public final class p0 implements fjf<Boolean> {
    private final wlf<AndroidFeaturePodcastEntityProperties> a;

    public p0(wlf<AndroidFeaturePodcastEntityProperties> wlf) {
        this.a = wlf;
    }
    ...
    public Object get() {
        ...
        return Boolean.valueOf(androidFeaturePodcastEntityProperties.b());
    }
}
