...
public final class PodcastEpisodeQuotesModule$Companion$provideSortShareDestinations$1 extends Lambda implements nmf<Set<? extends a>, List<? extends a>> {
    final /* synthetic */ List $destinationList;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PodcastEpisodeQuotesModule$Companion$provideSortShareDestinations$1(List list) {
        super(1);
