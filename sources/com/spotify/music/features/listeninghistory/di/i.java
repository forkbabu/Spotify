...
public final class i implements fjf<e<PodcastRowListeningHistory.Model>> {
    private final a a;
    private final wlf<EncoreConsumerEntryPoint> b;
    private final wlf<vd3> c;

    public i(a aVar, wlf<EncoreConsumerEntryPoint> wlf, wlf<vd3> wlf2) {
        this.a = aVar;
        this.b = wlf;
        this.c = wlf2;
    }
    ...
    public Object get() {
        ...
        return new e(new ListeningHistoryEncoreComponentsModule$providePodcastRowComponent$1(encoreConsumerEntryPoint), vd3, ListeningHistoryEncoreComponentsModule$providePodcastRowComponent$2.a, C0707R.id.encore_podcast_row_listening_history);
    }
}
