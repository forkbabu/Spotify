...
public final class j implements fjf<e<RadioRowListeningHistory.Model>> {
    private final a a;
    private final wlf<EncoreConsumerEntryPoint> b;
    private final wlf<vd3> c;

    public j(a aVar, wlf<EncoreConsumerEntryPoint> wlf, wlf<vd3> wlf2) {
        this.a = aVar;
        this.b = wlf;
        this.c = wlf2;
    }
    ...
    public Object get() {
        ...
        return new e(new ListeningHistoryEncoreComponentsModule$provideRadioRowComponent$1(encoreConsumerEntryPoint), vd3, ListeningHistoryEncoreComponentsModule$provideRadioRowComponent$2.a, C0707R.id.encore_radio_row_listening_history);
    }
}
