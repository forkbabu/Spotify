...
final class j<T, R> implements l<YourLibraryPinProto$PinResponse, YourLibraryXEvent.p> {
    ...
    public YourLibraryXEvent.p apply(YourLibraryPinProto$PinResponse yourLibraryPinProto$PinResponse) {
        ...
        return new YourLibraryXEvent.p(YourLibraryXEvent.PinAction.UNPIN, yourLibraryPinProto$PinResponse2);
    }
}
