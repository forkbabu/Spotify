...
public final class YourLibraryPodcastRowComponentViewHolder extends YourLibraryXSwipeableEntityViewHolder<PodcastRowLibrary.Model, PodcastRowLibrary.Events> {
    ...
    public YourLibraryPodcastRowComponentViewHolder(Component<PodcastRowLibrary.Model, PodcastRowLibrary.Events> component, r rVar, eh9 eh9) {
    ...
    public Object m0(y.a aVar) {
        ...
        String h = p.h();
        h.d(h, "item.entity.show.creatorName");
        String b = c.b(h);
        r rVar = this.H;
        YourLibraryResponseProto$YourLibraryShowExtraInfo p2 = aVar2.b().p();
        h.d(p2, "item.entity.show");
        LibraryItemDescription.Model.Show show = new LibraryItemDescription.Model.Show(b, rVar.S(p2), !this.H.B(j.b(b.f.class)));
        YourLibraryResponseProto$YourLibraryEntityInfo m3 = aVar2.b().m();
        h.d(m3, "item.entity.entityInfo");
        return new PodcastRowLibrary.Model(m2, show, com.spotify.music.features.yourlibraryx.b.e(m3), this.H.B0(aVar2.b()), aVar2.a(), this.H.J0(aVar2.b()));
    }
    ...
    public void l0(y.a aVar, nmf<? super YourLibraryXEvent, f> nmf) {
        ...
        h.d(m, "item.entity.entityInfo");
        ((Component) j0()).onEvent(new YourLibraryPodcastRowComponentViewHolder$bindEvents$1(this, m.p(), aVar, nmf));
    }
}
