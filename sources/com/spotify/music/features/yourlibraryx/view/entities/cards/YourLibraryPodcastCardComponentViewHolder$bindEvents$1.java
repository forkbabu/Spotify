...
public final class YourLibraryPodcastCardComponentViewHolder$bindEvents$1 extends Lambda implements nmf<PodcastCardLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryPodcastCardComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryPodcastCardComponentViewHolder$bindEvents$1(YourLibraryPodcastCardComponentViewHolder yourLibraryPodcastCardComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryPodcastCardComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(PodcastCardLibrary.Events events) {
        Object obj;
        PodcastCardLibrary.Events events2 = events;
