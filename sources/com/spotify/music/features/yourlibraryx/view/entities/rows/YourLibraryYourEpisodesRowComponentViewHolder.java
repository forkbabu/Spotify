...
public final class YourLibraryYourEpisodesRowComponentViewHolder extends YourLibraryXSwipeableEntityViewHolder<YourEpisodesRowLibrary.Model, YourEpisodesRowLibrary.Events> {
    ...
    public YourLibraryYourEpisodesRowComponentViewHolder(Component<YourEpisodesRowLibrary.Model, YourEpisodesRowLibrary.Events> component, r rVar, eh9 eh9) {
    ...
    public Object m0(y.a aVar) {
        ...
        LibraryItemDescription.Model.YourEpisodes yourEpisodes = new LibraryItemDescription.Model.YourEpisodes(i.i(), !this.H.B(j.b(b.e.class)) && !this.H.B(j.b(b.f.class)));
        ...
        return new YourEpisodesRowLibrary.Model(m2, yourEpisodes, com.spotify.music.features.yourlibraryx.b.d(l), this.H.B0(aVar2.b()), aVar2.a(), this.H.J0(aVar2.b()));
    }
    ...
    public void l0(y.a aVar, nmf<? super YourLibraryXEvent, f> nmf) {
        ...
        h.d(m, "item.entity.entityInfo");
        ((Component) j0()).onEvent(new YourLibraryYourEpisodesRowComponentViewHolder$bindEvents$1(this, m.p(), aVar, nmf));
    }
}
