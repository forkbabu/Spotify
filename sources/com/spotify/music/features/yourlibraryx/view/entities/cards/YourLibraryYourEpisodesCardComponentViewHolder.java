...
public final class YourLibraryYourEpisodesCardComponentViewHolder extends oh9<YourEpisodesCardLibrary.Model, YourEpisodesCardLibrary.Events> {
    private final r E;
    private final eh9 F;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public YourLibraryYourEpisodesCardComponentViewHolder(Component<YourEpisodesCardLibrary.Model, YourEpisodesCardLibrary.Events> component, r rVar, eh9 eh9) {
        super(component);
    ...
    public Object m0(y.a aVar) {
        ...
        LibraryItemDescription.Model.YourEpisodes yourEpisodes = new LibraryItemDescription.Model.YourEpisodes(i.i(), !this.E.B(j.b(b.e.class)) && !this.E.B(j.b(b.f.class)));
        ...
        return new YourEpisodesCardLibrary.Model(m2, yourEpisodes, com.spotify.music.features.yourlibraryx.b.d(l), this.E.B0(aVar2.b()), this.E.J0(aVar2.b()));
    }
    ...
    public void l0(y.a aVar, nmf<? super YourLibraryXEvent, f> nmf) {
        ...
        h.d(m, "item.entity.entityInfo");
        ((Component) j0()).onEvent(new YourLibraryYourEpisodesCardComponentViewHolder$bindEvents$1(this, m.p(), aVar, nmf));
    }
}
