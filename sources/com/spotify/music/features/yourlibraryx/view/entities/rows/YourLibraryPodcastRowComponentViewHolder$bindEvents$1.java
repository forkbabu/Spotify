...
public final class YourLibraryPodcastRowComponentViewHolder$bindEvents$1 extends Lambda implements nmf<PodcastRowLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryPodcastRowComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryPodcastRowComponentViewHolder$bindEvents$1(YourLibraryPodcastRowComponentViewHolder yourLibraryPodcastRowComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryPodcastRowComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(PodcastRowLibrary.Events events) {
        Object obj;
        PodcastRowLibrary.Events events2 = events;
