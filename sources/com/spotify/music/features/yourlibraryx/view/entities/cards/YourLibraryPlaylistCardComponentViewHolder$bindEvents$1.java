...
public final class YourLibraryPlaylistCardComponentViewHolder$bindEvents$1 extends Lambda implements nmf<PlaylistCardLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryPlaylistCardComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryPlaylistCardComponentViewHolder$bindEvents$1(YourLibraryPlaylistCardComponentViewHolder yourLibraryPlaylistCardComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryPlaylistCardComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(PlaylistCardLibrary.Events events) {
        Object obj;
        PlaylistCardLibrary.Events events2 = events;
