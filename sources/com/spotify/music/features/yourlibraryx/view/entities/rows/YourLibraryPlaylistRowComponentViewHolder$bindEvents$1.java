...
public final class YourLibraryPlaylistRowComponentViewHolder$bindEvents$1 extends Lambda implements nmf<PlaylistRowLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryPlaylistRowComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryPlaylistRowComponentViewHolder$bindEvents$1(YourLibraryPlaylistRowComponentViewHolder yourLibraryPlaylistRowComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryPlaylistRowComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(PlaylistRowLibrary.Events events) {
        Object obj;
        PlaylistRowLibrary.Events events2 = events;
