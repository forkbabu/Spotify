...
public final class YourLibraryAlbumRowComponentViewHolder$bindEvents$1 extends Lambda implements nmf<AlbumRowLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryAlbumRowComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryAlbumRowComponentViewHolder$bindEvents$1(YourLibraryAlbumRowComponentViewHolder yourLibraryAlbumRowComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryAlbumRowComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(AlbumRowLibrary.Events events) {
        Object obj;
        AlbumRowLibrary.Events events2 = events;
