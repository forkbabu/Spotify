...
public final class YourLibraryArtistCardComponentViewHolder$bindEvents$1 extends Lambda implements nmf<ArtistCardLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryArtistCardComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryArtistCardComponentViewHolder$bindEvents$1(YourLibraryArtistCardComponentViewHolder yourLibraryArtistCardComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryArtistCardComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(ArtistCardLibrary.Events events) {
        Object obj;
        ArtistCardLibrary.Events events2 = events;
