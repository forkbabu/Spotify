...
public final class YourLibraryYourEpisodesRowComponentViewHolder$bindEvents$1 extends Lambda implements nmf<YourEpisodesRowLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryYourEpisodesRowComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryYourEpisodesRowComponentViewHolder$bindEvents$1(YourLibraryYourEpisodesRowComponentViewHolder yourLibraryYourEpisodesRowComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryYourEpisodesRowComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(YourEpisodesRowLibrary.Events events) {
        Object obj;
        YourEpisodesRowLibrary.Events events2 = events;
