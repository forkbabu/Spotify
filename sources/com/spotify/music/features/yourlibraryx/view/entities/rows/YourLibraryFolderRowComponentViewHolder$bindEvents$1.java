...
public final class YourLibraryFolderRowComponentViewHolder$bindEvents$1 extends Lambda implements nmf<FolderRowLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryFolderRowComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryFolderRowComponentViewHolder$bindEvents$1(YourLibraryFolderRowComponentViewHolder yourLibraryFolderRowComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryFolderRowComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(FolderRowLibrary.Events events) {
        Object obj;
        FolderRowLibrary.Events events2 = events;
