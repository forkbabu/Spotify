...
public final class YourLibraryYourEpisodesCardComponentViewHolder$bindEvents$1 extends Lambda implements nmf<YourEpisodesCardLibrary.Events, f> {
    final /* synthetic */ y.a $item;
    final /* synthetic */ nmf $output;
    final /* synthetic */ String $uri;
    final /* synthetic */ YourLibraryYourEpisodesCardComponentViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    YourLibraryYourEpisodesCardComponentViewHolder$bindEvents$1(YourLibraryYourEpisodesCardComponentViewHolder yourLibraryYourEpisodesCardComponentViewHolder, String str, y.a aVar, nmf nmf) {
        super(1);
        this.this$0 = yourLibraryYourEpisodesCardComponentViewHolder;
        this.$uri = str;
        this.$item = aVar;
        this.$output = nmf;
    }
    ...
    public f invoke(YourEpisodesCardLibrary.Events events) {
        Object obj;
        YourEpisodesCardLibrary.Events events2 = events;
