...
final /* synthetic */ class ProfileListPage$content$1 extends FunctionReferenceImpl implements nmf<e, f> {
    ProfileListPage$content$1(ProfileListPage profileListPage) {
    ...
    public f invoke(e eVar) {
        ...
        if (eVar2.c() != LoadingState.FAILED) {
            return f.a;
        }
