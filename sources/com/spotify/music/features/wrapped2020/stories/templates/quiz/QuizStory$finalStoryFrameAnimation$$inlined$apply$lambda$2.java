...
final class QuizStory$finalStoryFrameAnimation$$inlined$apply$lambda$2 extends Lambda implements cmf<f> {
    ...
    QuizStory$finalStoryFrameAnimation$$inlined$apply$lambda$2(AnimatorSet animatorSet, QuizStory quizStory, long j) {
        super(0);
