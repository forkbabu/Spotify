...
final class YourEpisodesDownloadListenerImpl$onDownloadClick$5 extends Lambda implements nmf<a.c, f> {
    ...
    YourEpisodesDownloadListenerImpl$onDownloadClick$5(YourEpisodesDownloadListenerImpl yourEpisodesDownloadListenerImpl, String str, String str2, int i) {
        super(1);
