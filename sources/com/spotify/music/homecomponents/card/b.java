...
public final class b implements fjf<a> {
    ...
    public b(wlf<Context> wlf, wlf<Picasso> wlf2, wlf<po9> wlf3, wlf<m71> wlf4, wlf<w50> wlf5) {
        this.a = wlf;
        this.b = wlf2;
        this.c = wlf3;
        this.d = wlf4;
    ...
    public static b a(wlf<Context> wlf, wlf<Picasso> wlf2, wlf<po9> wlf3, wlf<m71> wlf4, wlf<w50> wlf5) {
