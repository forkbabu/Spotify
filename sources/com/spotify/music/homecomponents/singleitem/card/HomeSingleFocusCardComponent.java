...
public final class HomeSingleFocusCardComponent extends HomeBaseSingleFocusCardComponent {
    ...
    public HomeSingleFocusCardComponent(Activity activity, Picasso picasso, m71 m71, n nVar, b bVar, b bVar2, g<PlayerState> gVar) {
    ...
    public HomeSingleFocusCardViewBinder.Size a() {
        return HomeSingleFocusCardViewBinder.Size.STANDARD;
    }

    public int d() {
        return C0707R.id.home_single_focus_card_component;
    }
}
