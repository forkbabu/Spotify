...
public final class ClusterRadioStationModel_Deserializer extends StdDeserializer<ClusterRadioStationModel> {
    ...
    public ClusterRadioStationModel a(JsonParser jsonParser, DeserializationContext deserializationContext) {
        char c;
            ...
            if (jsonParser.getCurrentToken().ordinal() == 5) {
                ...
                switch (currentName.hashCode()) {
                    ...
                    case -1724546052:
                        ...
                        break;
                    case -1141536684:
                        if (currentName.equals("clusterType")) {
                            c = 4;
                            break;
                        }
                        c = 65535;
                                    ...
                                    while (true) {
                                        ...
                                        while (true) {
                                            if (jsonParser.nextToken() == JsonToken.END_OBJECT) {
                                                playerTrack = new PlayerTrack(str12, str13, str14, str15, str16, hashMap);
                        ...
                        if (jsonParser.getCurrentToken() == JsonToken.VALUE_NULL) {
                            ...
                            while (jsonParser.nextToken() != JsonToken.END_ARRAY) {
                                if (jsonParser.getCurrentToken() == JsonToken.VALUE_NULL) {
                                    ...
                                    relatedArtistModel = RelatedArtistModel.create(str17, str18);
                                }
        ...
        return new ClusterRadioStationModel(str, str2, str3, str4, str5, str6, str7, strArr, relatedArtistModelArr, playerTrackArr, str8, z, str9, str10, str11);
    }
