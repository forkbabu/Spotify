...
final /* synthetic */ class YourLibraryXPinHelperImpl$pin$2 extends FunctionReferenceImpl implements nmf<fi0, z<YourLibraryPinProto$PinResponse>> {
    YourLibraryXPinHelperImpl$pin$2(ei0 ei0) {
        super(1, ei0, ei0.class, "pinItem", "pinItem(Lcom/spotify/collection/endpoints/yourlibrary/pin/YourLibraryPinEndpointConfiguration;)Lio/reactivex/Single;", 0);
    }
    ...
    public z<YourLibraryPinProto$PinResponse> invoke(fi0 fi0) {
        fi0 fi02 = fi0;
        h.e(fi02, "p1");
        return ((ei0) this.receiver).c(fi02);
    }
}
