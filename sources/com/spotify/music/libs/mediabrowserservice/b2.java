...
public class b2 {
    ...
    public b2(wlf<cqe> wlf, wlf<d> wlf2, wlf<pea> wlf3, wlf<e0> wlf4, wlf<p> wlf5, wlf<b3> wlf6, wlf<v1> wlf7) {
        a(wlf, 1);
        this.a = wlf;
        a(wlf2, 2);
        this.b = wlf2;
    ...
    public a2 b(v1 v1Var, PlayOrigin playOrigin) {
        a(v1Var, 1);
        a(playOrigin, 2);
        cqe cqe = this.a.get();
        a(cqe, 3);
        ...
        a(v1Var2, 9);
        return new a2(v1Var, playOrigin, cqe2, dVar2, pea2, e0Var2, pVar2, b3Var2, v1Var2);
    }
}
