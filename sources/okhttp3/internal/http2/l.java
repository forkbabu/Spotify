...
class l {
    ...
    private l() {
        ...
        while (true) {
            ...
            if (i < bArr.length) {
                ...
                while (b2 > 8) {
                    b2 = (byte) (b2 - 8);
                    int i3 = (i2 >>> b2) & BitmapRenderer.ALPHA_VISIBLE;
                    a[] aVarArr = aVar2.a;
                    if (aVarArr != null) {
                        if (aVarArr[i3] == null) {
                            aVarArr[i3] = new a();
                ...
                int i4 = 8 - b2;
                int i5 = (i2 << i4) & BitmapRenderer.ALPHA_VISIBLE;
                int i6 = 1 << i4;
    ...
    public byte[] a(byte[] bArr) {
        ...
        for (byte b2 : bArr) {
            ...
            i2 += 8;
            while (i2 >= 8) {
                aVar = aVar.a[(i >>> (i2 - 8)) & BitmapRenderer.ALPHA_VISIBLE];
                if (aVar.a == null) {
        ...
        while (i2 > 0) {
            a aVar2 = aVar.a[(i << (8 - i2)) & BitmapRenderer.ALPHA_VISIBLE];
    ...
    /* access modifiers changed from: package-private */
    public void b(ByteString byteString, f fVar) {
        int i = 0;
        long j = 0;
        byte b2 = 0;
        while (i < byteString.x()) {
            int n = byteString.n(i) & 255;
            int i2 = b[n];
            byte b3 = c[n];
            j = (j << b3) | ((long) i2);
            int i3 = b2 + b3;
        ...
        if (b2 > 0) {
            ((e) fVar).J((int) (((long) (BitmapRenderer.ALPHA_VISIBLE >>> b2)) | (j << (8 - b2))));
        }
    }
    ...
    public int c(ByteString byteString) {
        long j = 0;
        for (int i = 0; i < byteString.x(); i++) {
            j += (long) c[byteString.n(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
