...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private static int s(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return s(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L_0x0050:
            ...
            r7 = r2
        L_0x0073:
            int r8 = defpackage.q4.o(r9)
            int r7 = defpackage.e2.h(r7, r8)
            r7 = r7 & 7
            r8 = 1
        ...
        while (true) {
            if (i8 < childCount) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (id == C0707R.id.topPanel) {
                        view = childAt;
                    } else if (id == C0707R.id.buttonPanel) {
                        view2 = childAt;
                    } else if ((id == C0707R.id.contentPanel || id == C0707R.id.customPanel) && view3 == null) {
                        view3 = childAt;
                    }
                }
                i8++;
